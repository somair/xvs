...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hours_endorsement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('commitment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hours.Commitment'], unique=True)),
            ('representative', self.gf('django.db.models.fields.related.ForeignKey')(related_name='representative', to=orm['auth.User'])),
            ('endorsement_text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('hours', ['Endorsement'])


    def backwards(self, orm):
        # Deleting model 'Endorsement'
        db.delete_table('hours_endorsement')
