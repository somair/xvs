...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkExperience.confirmed'
        db.add_column('work_experience_workexperience', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkExperience.confirmed'
        db.delete_column('work_experience_workexperience', 'confirmed')
    ...
    models = {
        ...
        'work_experience.workexperience': {
            ...
            'confirmation_code': ('django.db.models.fields.CharField', [], {'default': "'91919c2d-dd34-43e5-b61f-e4874818f67a'", 'max_length': '255'}),
