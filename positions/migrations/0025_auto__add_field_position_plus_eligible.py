...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Position.plus_eligible'
        db.add_column('positions_position', 'plus_eligible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Position.plus_eligible'
        db.delete_column('positions_position', 'plus_eligible')
    ...
    models = {
        ...
        'positions.position': {
            ...
            'plus_eligible': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
