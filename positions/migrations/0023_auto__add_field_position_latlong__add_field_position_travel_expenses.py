...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Position.latlong'
        db.add_column('positions_position', 'latlong',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.travel_expenses'
        db.add_column('positions_position', 'travel_expenses',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Position.latlong'
        db.delete_column('positions_position', 'latlong')

        # Deleting field 'Position.travel_expenses'
        db.delete_column('positions_position', 'travel_expenses')
