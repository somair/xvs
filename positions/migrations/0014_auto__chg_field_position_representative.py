...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Position.representative'
        db.alter_column('positions_position', 'representative_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Position.representative'
        db.alter_column('positions_position', 'representative_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
