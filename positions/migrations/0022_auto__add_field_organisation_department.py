...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.department'
        db.add_column('positions_organisation', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Department'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.department'
        db.delete_column('positions_organisation', 'department_id')
