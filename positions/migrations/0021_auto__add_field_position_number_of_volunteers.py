...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Position.number_of_volunteers'
        db.add_column('positions_position', 'number_of_volunteers',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Position.number_of_volunteers'
        db.delete_column('positions_position', 'number_of_volunteers')
