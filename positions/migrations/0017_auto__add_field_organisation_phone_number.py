...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.phone_number'
        db.add_column('positions_organisation', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.phone_number'
        db.delete_column('positions_organisation', 'phone_number')
