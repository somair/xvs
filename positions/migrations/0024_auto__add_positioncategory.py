...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('positions_positioncategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('positions', ['PositionCategory'])

        # Adding M2M table for field category on 'Position'
        m2m_table_name = db.shorten_name('positions_position_category')
        ...
        db.create_unique(m2m_table_name, ['position_id', 'positioncategory_id'])


    def backwards(self, orm):
        # Deleting model 'PositionCategory'
        db.delete_table('positions_positioncategory')

        # Removing M2M table for field category on 'Position'
        db.delete_table(db.shorten_name('positions_position_category'))
