...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organisation.date_created'
        db.add_column('positions_organisation', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Position.date_created'
        db.add_column('positions_position', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organisation.date_created'
        db.delete_column('positions_organisation', 'date_created')

        # Deleting field 'Position.date_created'
        db.delete_column('positions_position', 'date_created')
