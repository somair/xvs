...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.volunteer_policy'
        db.add_column('positions_organisation', 'volunteer_policy',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.volunteer_policy'
        db.delete_column('positions_organisation', 'volunteer_policy')
