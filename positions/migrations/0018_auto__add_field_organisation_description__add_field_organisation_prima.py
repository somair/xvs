...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.description'
        db.add_column('positions_organisation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Organisation.primary_image'
        db.add_column('positions_organisation', 'primary_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.description'
        db.delete_column('positions_organisation', 'description')

        # Deleting field 'Organisation.primary_image'
        db.delete_column('positions_organisation', 'primary_image')
