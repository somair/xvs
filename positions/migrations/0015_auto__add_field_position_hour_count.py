...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Position.hour_count'
        db.add_column('positions_position', 'hour_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Position.hour_count'
        db.delete_column('positions_position', 'hour_count')
    ...
    models = {
        ...
        'positions.position': {
            ...
            'hour_count': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
