...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VolunteerProfile.referencefile'
        db.add_column('profiles_volunteerprofile', 'referencefile',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VolunteerProfile.referencefile'
        db.delete_column('profiles_volunteerprofile', 'referencefile')
