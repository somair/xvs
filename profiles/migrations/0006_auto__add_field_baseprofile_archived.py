...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseProfile.archived'
        db.add_column('profiles_baseprofile', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseProfile.archived'
        db.delete_column('profiles_baseprofile', 'archived')
