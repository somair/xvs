...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseProfile.department'
        db.add_column('profiles_baseprofile', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Department'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseProfile.department'
        db.delete_column('profiles_baseprofile', 'department_id')
