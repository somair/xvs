...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VolunteerProfile.photo'
        db.add_column('profiles_volunteerprofile', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VolunteerProfile.photo'
        db.delete_column('profiles_volunteerprofile', 'photo')
