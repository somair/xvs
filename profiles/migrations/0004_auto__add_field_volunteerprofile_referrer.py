...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VolunteerProfile.referrer'
        db.add_column('profiles_volunteerprofile', 'referrer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VolunteerProfile.referrer'
        db.delete_column('profiles_volunteerprofile', 'referrer')
