...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HowDidYouHear'
        db.create_table('profiles_howdidyouhear', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('how', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('profiles', ['HowDidYouHear'])


    def backwards(self, orm):
        # Deleting model 'HowDidYouHear'
        db.delete_table('profiles_howdidyouhear')
