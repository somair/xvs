...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_award', (
            ...
            ('award', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.AwardType'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date_awarded', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('profiles', ['Award'])

        # Adding model 'AwardType'
        db.create_table('profiles_awardtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('hours_required', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('profiles', ['AwardType'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_awardtype')
