...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_volunteerprofile', 'address',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'VolunteerProfile.student_id'
        db.add_column('profiles_volunteerprofile', 'student_id',
                      self.gf('django.db.models.fields.CharField')(max_length=31, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VolunteerProfile.student_id'
        db.delete_column('profiles_volunteerprofile', 'student_id')
    ...
    models = {
        ...
        'profiles.volunteerprofile': {
            ...
            'student_id': ('django.db.models.fields.CharField', [], {'max_length': '31', 'null': 'True'}),
