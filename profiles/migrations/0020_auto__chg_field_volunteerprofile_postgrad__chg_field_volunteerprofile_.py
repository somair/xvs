...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseProfile.communication'
        db.add_column('profiles_baseprofile', 'communication',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BaseProfile.communication'
        db.delete_column('profiles_baseprofile', 'communication')
