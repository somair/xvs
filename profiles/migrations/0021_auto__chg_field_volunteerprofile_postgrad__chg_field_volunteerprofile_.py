...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'VolunteerProfile'
        m2m_table_name = db.shorten_name('profiles_volunteerprofile_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('volunteerprofile', models.ForeignKey(orm['profiles.volunteerprofile'], null=False)),
            ('positioncategory', models.ForeignKey(orm['positions.positioncategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['volunteerprofile_id', 'positioncategory_id'])


        # Changing field 'VolunteerProfile.postgrad'
        db.alter_column('profiles_volunteerprofile', 'postgrad', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VolunteerProfile.year'
        db.alter_column('profiles_volunteerprofile', 'year', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Removing M2M table for field categories on 'VolunteerProfile'
        db.delete_table(db.shorten_name('profiles_volunteerprofile_categories'))


        # Changing field 'VolunteerProfile.postgrad'
        db.alter_column('profiles_volunteerprofile', 'postgrad', self.gf('django.db.models.fields.BooleanField')())

        # User chose to not deal with backwards NULL issues for 'VolunteerProfile.year'
        raise RuntimeError("Cannot reverse this migration. 'VolunteerProfile.year' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'VolunteerProfile.year'
        db.alter_column('profiles_volunteerprofile', 'year', self.gf('django.db.models.fields.PositiveIntegerField')())
