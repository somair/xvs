...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VolunteerProfile.contact_email'
        db.add_column('profiles_volunteerprofile', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VolunteerProfile.contact_email'
        db.delete_column('profiles_volunteerprofile', 'contact_email')
