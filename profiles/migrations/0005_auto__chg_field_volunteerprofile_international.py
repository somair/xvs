...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VolunteerProfile.international'
        db.alter_column('profiles_volunteerprofile', 'international', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Changing field 'VolunteerProfile.international'
        db.alter_column('profiles_volunteerprofile', 'international', self.gf('django.db.models.fields.BooleanField')())
