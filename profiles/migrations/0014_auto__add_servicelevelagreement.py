...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_servicelevelagreement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('statement', self.gf('django.db.models.fields.TextField')()),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('profiles', ['ServiceLevelAgreement'])

        # Adding M2M table for field slas on 'BaseProfile'
        db.create_table('profiles_baseprofile_slas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baseprofile', models.ForeignKey(orm['profiles.baseprofile'], null=False)),
            ('servicelevelagreement', models.ForeignKey(orm['profiles.servicelevelagreement'], null=False))
        ))
        db.create_unique('profiles_baseprofile_slas', ['baseprofile_id', 'servicelevelagreement_id'])


    def backwards(self, orm):
        # Deleting model 'ServiceLevelAgreement'
        db.delete_table('profiles_servicelevelagreement')

        # Removing M2M table for field slas on 'BaseProfile'
        db.delete_table('profiles_baseprofile_slas')
    ...
    models = {
        ...
        'profiles.baseprofile': {
            ...
            'slas': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['profiles.ServiceLevelAgreement']", 'symmetrical': 'False'}),
