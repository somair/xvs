...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VolunteerProfile.school'
        db.add_column('profiles_volunteerprofile', 'school',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VolunteerProfile.school'
        db.delete_column('profiles_volunteerprofile', 'school')
