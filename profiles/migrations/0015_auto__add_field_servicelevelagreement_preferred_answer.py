...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceLevelAgreement.preferred_answer'
        db.add_column('profiles_servicelevelagreement', 'preferred_answer',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceLevelAgreement.preferred_answer'
        db.delete_column('profiles_servicelevelagreement', 'preferred_answer')
