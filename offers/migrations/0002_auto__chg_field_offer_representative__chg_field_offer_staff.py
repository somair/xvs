...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.representative'
        db.alter_column('offers_offer', 'representative_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Offer.staff'
        db.alter_column('offers_offer', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Offer.representative'
        db.alter_column('offers_offer', 'representative_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Offer.staff'
        db.alter_column('offers_offer', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
