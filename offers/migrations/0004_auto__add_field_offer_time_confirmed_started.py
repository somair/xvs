...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.time_confirmed_started'
        db.add_column('offers_offer', 'time_confirmed_started',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.time_confirmed_started'
        db.delete_column('offers_offer', 'time_confirmed_started')
    ...
    models = {
        ...
        'offers.offer': {
            ...
            'time_confirmed_started': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
