...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Offer.time_withdrawn'
        db.add_column('offers_offer', 'time_withdrawn', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Offer.time_withdrawn'
        db.delete_column('offers_offer', 'time_withdrawn')
